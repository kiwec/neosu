...
{
  integer_sort(std::ranges::begin(range), std::ranges::end(range));
}
...
{
  integer_sort(std::ranges::begin(range), std::ranges::end(range), shift, comp);
}
...
{
  integer_sort(std::ranges::begin(range), std::ranges::end(range), shift);
}
}
}
}
