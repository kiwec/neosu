...
Some performance plots of runtime vs. n and log(range) are provided:\n
  ...
  */
  ...
  {
    float_sort(std::ranges::begin(range), std::ranges::end(range));
  }
  ...
  */
  ...
  {
      float_sort(std::ranges::begin(range), std::ranges::end(range), rshift);
  }
  ...
  */
  ...
  {
      float_sort(std::ranges::begin(range), std::ranges::end(range), rshift, comp);
  }
}
}
}
