...
{
  string_sort(std::ranges::begin(range), std::ranges::end(range), unused);
}
...
{
  string_sort(std::ranges::begin(range), std::ranges::end(range));
}
...
{
  reverse_string_sort(std::ranges::begin(range), std::ranges::end(range), comp, unused);
}
...
{
  reverse_string_sort(std::ranges::begin(range), std::ranges::end(range), comp);
}
...
{
  string_sort(std::ranges::begin(range), std::ranges::end(range), get_character, length);
}
...
inline void string_sort(Range& range,
                        Get_char get_character, Get_length length, Compare comp)
{
  string_sort(std::ranges::begin(range), std::ranges::end(range), get_character, length, comp);
}
...
{
    reverse_string_sort(std::ranges::begin(range), std::ranges::end(range), get_character, length, comp);
}
}
}
}
