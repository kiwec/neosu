                     ...
                     const Iter2_t end_buf2, Iter3_t buf_out, Compare comp)
{
    ...
    static_assert (std::is_same_v< value1_t, value2_t >,
                    "Incompatible iterators\n");
    static_assert (std::is_same_v< value3_t, value2_t >,
                    "Incompatible iterators\n");
                                ...
                                Value_t *it_out, Compare comp)
{
    ...
    static_assert (std::is_same_v< Value_t, type1 >,
                    "Incompatible iterators\n");
    static_assert (std::is_same_v< Value_t, type2 >,
                    "Incompatible iterators\n");
                               ...
                               Iter3_t aux, Compare comp)
{
    ...
    static_assert (std::is_same_v< type1, type2 >,
                    "Incompatible iterators\n");
    static_assert (std::is_same_v< type3, type2 >,
                    "Incompatible iterators\n");
