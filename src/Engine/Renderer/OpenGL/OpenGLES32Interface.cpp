...
void OpenGLES32Interface::drawRectf(const RectOptions &opts) {
    ...
    // for line thickness > 1, draw as filled rectangles
...
void OpenGLES32Interface::fillGradient(int x, int y, int width, int height, Color topLeftColor, Color topRightColor,
...
void OpenGLES32Interface::drawQuad(vec2 topLeft, vec2 topRight, vec2 bottomRight, vec2 bottomLeft, Color topLeftColor,
