...
CONVAR(database_version, OSU_VERSION_DATESTR, CLIENT | NOLOAD | NOSAVE,
...
CONVAR(mp_server, "neosu.net"sv, CLIENT);
...
CONVAR(interpolate_music_pos, true, CLIENT | SKINS | SERVER, "interpolate song position with engine time");
...
CONVAR(load_db_immediately, false, CLIENT);
