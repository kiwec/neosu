...
// media keys
#define KEY_PLAY SDL_SCANCODE_MEDIA_PLAY
#define KEY_PAUSE SDL_SCANCODE_MEDIA_PAUSE
#define KEY_PLAYPAUSE SDL_SCANCODE_MEDIA_PLAY_PAUSE
#define KEY_STOP SDL_SCANCODE_MEDIA_STOP
#define KEY_PREV SDL_SCANCODE_MEDIA_PREVIOUS_TRACK
#define KEY_NEXT SDL_SCANCODE_MEDIA_NEXT_TRACK
